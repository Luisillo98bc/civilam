...
export default function CTA() {
  const whatsappMessage = [
    '*HOLA, EQUIPO CIVILAM*',
    '━━━━━━━━━━━━━━━━━━━━',
    '🏗️ Me gustaría evaluar un proyecto con su equipo de ingeniería.',
    '',
    '📌 *Objetivo:*',
    'Quisiera recibir orientación sobre el servicio más adecuado y los próximos pasos.',
    '',
    ...
    <section id="contacto" className="relative overflow-hidden bg-[#e5a72a] py-20 text-[#102a43] lg:py-28">
      ...
      <div className="site-wrapper relative grid gap-10 lg:grid-cols-[1fr_auto] lg:items-end">
        ...
        <div className="flex flex-col gap-3 sm:flex-row lg:flex-col">
          ...
          <a href={contact.whatsapp + '?text=' + encodeURIComponent(whatsappMessage)} target="_blank" rel="noopener noreferrer" className="inline-flex min-h-13 items-center justify-center border border-[#102a43] px-8 py-4 font-bold transition hover:bg-white/30">Enviar por WhatsApp</a>
        </div>
      </div>
    </section>
  );
