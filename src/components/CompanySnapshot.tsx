  ...
  return (
    <section className="section bg-[#fbfaf7]" aria-labelledby="company-snapshot-title">
      <div className="site-wrapper">
        <div className="grid gap-px bg-slate-300 lg:grid-cols-2" data-reveal="reveal-scale">
        ...
        <div className="mt-10 grid gap-8 border-y border-slate-300 py-8 lg:grid-cols-[1fr_1.4fr] lg:items-center" data-reveal>
